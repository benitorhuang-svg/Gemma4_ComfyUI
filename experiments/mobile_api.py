...
def process_image(idea: str):
    ...
    # 1. 請求 Gemma 4
    system_prompt = "Expand user input into a hyper-detailed Stable Diffusion prompt. English only. No conversational filler."
    payload = {
...
async def generate_image(req: ImageRequest, background_tasks: BackgroundTasks):
    ...
    return {"status": "success", "message": "任務已提交背景執行，請稍後至 ComfyUI 查看結果。"}
